#!/usr/bin/env python3
"""Chuyển đổi MES_TAG_NAME_SHOPFLOOR.md sang file Excel."""
import os
import re


def parse_markdown_tables(content: str):
    """Trích xuất các bảng markdown từ nội dung (copy logic từ md-to-excel)."""
    tables = []
    lines = content.split("\n")
    i = 0
...
def main():
    ...
    md_path = os.path.join(project_dir, "docs", "MES_TAG_NAME_SHOPFLOOR.md")
    output_path = os.path.join(project_dir, "docs", "MES_TAG_NAME_SHOPFLOOR.xlsx")
