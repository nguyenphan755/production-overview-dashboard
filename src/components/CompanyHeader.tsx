import { Factory, MapPin, Clock } from 'lucide-react';
...
export function CompanyHeader() {
  ...
  return (
    <div className="mb-2 rounded-2xl bg-gradient-to-r from-white/10 via-white/5 to-transparent backdrop-blur-xl border border-white/20 shadow-2xl overflow-hidden">
