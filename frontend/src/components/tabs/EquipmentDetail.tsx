...
import { ArrowLeft, User, Package, Activity, Target, TrendingUp, Gauge, Zap, Thermometer, Circle, Flame, Battery, History, Clock, CheckCircle, XCircle, AlertCircle, Layers, FileDown, ChevronDown, ChevronUp, ExternalLink } from 'lucide-react';
...
export function EquipmentDetail({
  ...
  const speedAnalysisRefs = useMemo(() => {
    ...
    const refTarget = liveModes.includes(equipmentOeeMode)
      ? (machine?.targetSpeed ?? activeSpeedHistory?.summary.currentTargetSpeed ?? null)
      : (activeSpeedHistory?.summary.currentTargetSpeed ?? machine?.targetSpeed ?? null);
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-xs text-cyan-400/80 hover:text-cyan-300 border border-cyan-500/30 rounded-lg px-2.5 py-1 whitespace-nowrap"
