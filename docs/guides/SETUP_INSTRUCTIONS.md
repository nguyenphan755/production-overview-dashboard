...
- If database `production_dashboard` does not exist yet, create it first:
...
## 3. Run Database Migration / Schema Setup
...
Alternative (if your backend scripts are available and preferred):
